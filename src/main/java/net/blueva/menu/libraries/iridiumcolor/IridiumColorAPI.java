 ...
 *
 */
package net.blueva.menu.libraries.iridiumcolor;

import com.google.common.collect.ImmutableMap;
import net.blueva.menu.libraries.iridiumcolor.patterns.GradientPattern;
import net.blueva.menu.libraries.iridiumcolor.patterns.Pattern;
